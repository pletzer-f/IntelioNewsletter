 ...
 */
const OPUS_MODEL = 'claude-opus-4-8';   // accuracy-critical work (macro generation + verification)
...
/** USD cost from a usage accumulator carrying sonnet + opus token buckets. */
...
// Macro (01) is the most figure-critical section → Opus 4.8 + adaptive thinking.
export const runAgent01 = (client, profile, sr, usage, ds) => runSectionAgent(1, client, profile, sr, usage, ds, { model: OPUS_MODEL, thinking: true, maxTokens: 16000 });
...
- Do NOT add new stories, headlines, or facts; do NOT rewrite correct prose. Only correct/remove unsupported figures and links.
