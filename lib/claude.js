...
const MAX_TOK_MACRO = 3500;  // agent01 (Macro & Markets): 6-8 stories → ~2800 tokens output
const MAX_TOK_SEC   = 2000;  // agents 02-06: 3-5 stories → ~1400 tokens output
...
Produce between 6 and 8 story cards covering the most important macro and market developments.
This is the flagship section — prioritise breadth: monetary policy, inflation, FX, commodities, PMI, regional economic signals.
Section ID: bsec-01
...
Use the ## Output format exactly: story-lead for the first story, story-grid/story-card for the rest.`;
  ...
  return complete(agentSystem('01', client), user, MAX_TOK_MACRO);
}
...
Produce between 3 and 5 story cards covering the most important core industry and operational developments.
Section ID: bsec-02
...
Produce between 3 and 5 story cards covering the most important PE, M&A, and deal activity.
Section ID: bsec-03
...
Produce between 3 and 5 story cards covering the most important end-market demand signals.
Section ID: bsec-04
...
Produce between 3 and 5 story cards covering the most important capex, financing, and asset market developments.
Section ID: bsec-05
...
Produce between 3 and 5 story cards covering local policy, regulation, and company reputation signals.
Section ID: bsec-06
