...
- PRIORITY BOX — the "Prioritäten heute"/"Today's priorities" <div> after summary-prep is part of the required format: keep it. Verify each priority topic and its materiality/urgency claim is grounded in a section; a market indicator must not be framed as direct operational evidence. TONE: analysis only — rewrite any row that assigns a task to a person/role or sets a deadline ("Treasury: … bis Freitag aufbereiten") into decision-relevant analysis naming the observable metric/release instead.
- Do NOT add new stories, themes, or facts; do NOT rewrite prose that is already correct; keep the exact HTML structure (<p class="summary-prep">, the priority box, the sum-list items, the Key Themes block).
