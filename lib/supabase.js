...
export async function saveBriefing(clientId, html, date, inputTokens = null, outputTokens = null) {
  const row = {
    client_id:  clientId,
    html,
    date,
  ...
  // Persist token usage when supplied (powers the admin cost dashboard).
